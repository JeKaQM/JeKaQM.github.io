  ...
  <div class="body contact-us">
    ...
    <div class="container transparent-bg">
      ...
      <div class="form-container">
        ...
        <form name="form" class="contact-form" id="contact_form" method="post" action="/contact.php" enctype="multipart/form-data" onsubmit="validateContactForm()">
          ...
          <div id="question">
            <div class="row-1">
              <div class="dropdown-question">
                <select class="dropdown" name="reason" style="margin-top: 5px">
          ...
          <div class="row-1">
            ...
            <div class="border">
              <textarea cols="80" rows="8" class="subject input-field" name="message" placeholder="Describe the situation in your words"></textarea>
            </div>
